...
How to use: 
  Download DTX-Eyes-vX.XX.py. This tool is used just like any other command line tool. Please use Python 3 for best results. 
  
  Open your command line and type 'pythonX' (X being your python version), followed by the path to where you saved this program, followed by the path to the file you are inputting.
